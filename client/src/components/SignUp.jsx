...
function SignUp() {
  ...
  const create = (e) => {
    e.preventDefault()
    axios.post("http://localhost:3001/signup", {nombre, mail, password}, {withCredentials: true}).then(resp => {console.log(resp)}).catch(err => {console.log(err)})
  }
  ...
  return (
    <div className="bg-2">
        <section className="sign">
            ...
            <p>¿Ya tienes una cuenta? <a href="/signin" className="underline">Inicia sesión aquí</a></p>
        </section>
    </div>
  );
}
